...
<div id="main">
    <div id="header">
        <a href="/">
            <div id="title"><h1><a title="Sploder"><img style="margin-top:-20px; height: 130px"
                                                        src="/chrome/logo.png"><span
                                class="hide">Games at Sploder</span></a></h1></div>
            <div id="tools"></div>
        </a>
    </div>
    <div id="page">
        <div id="content"><h3>Join Sploder Revival!</h3>
            <p style="font-size: 120%; line-height: 160%;">
                Membership is absolutely free! Just fill out the form below. Please be sure you understand our privacy
                policy
            ...
            <div class="textform">
                ...
                <form name="form" action="migrationcheck.php" method="post" onsubmit="return CheckData()">
                    <table cellpadding="4">
                        ...
                        <tr>
                            <td colspan="3">A yellow warning sign symbolises that the username needs to be migrated from
                        ...
                        <tr>
                            <td colspan="3">A green check sign symbolises that the username can be registered without
                                issues!
                            </td>
