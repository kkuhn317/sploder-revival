...
<div id="content"><h3>Sploder Revival Staff</h3><div id="venue" style="margin: -30px 0 -5px 20px; float: right;"></div>
...
<div class="gameobject" style="width: 570px; height: 428px;">
	...
	<br /><br/><br /><br /><br/><br /><center>Loading staff members...</center><br /><br/><br /><br /><br/><br />
...
<script type="text/javascript">
    ...
    swfobject.embedSWF('../swf/staffmembers.swf', 'spotlight', '570', '428', '8', '/swfobject/expressInstall.swf', null, { bgcolor: "" });

</script>



<p>Welcome to the Sploder Revival Staff page. All staff are Sploder Revival members who have devoted their time to make Sploder Revival a better place. 
