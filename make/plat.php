...
swfobject.embedSWF("../swf/creator2_b17.swf", "flashcontent", "860", "540", "10.0.0", "/swfobject/expressInstall.swf", flashvars, params);
...
<?php include('../content/headernavigation.php'); ?>
		...
		<?php include('../content/subnav.php'); ?>
			...
			<div id="content"><h3>Platformer Game Maker</h3>
...
<div id="creatorcontainer" style="width: 860px;">
	...
	<div style="margin: 20px auto; text-align: center; width: 425px;">
	    ...
	    <p>Make your own platformer game with this game maker.  Add ninjas, dragons, and other bad guys and battle them with swords, guns, and other cool weapons.</p>
        <?php
