...
swfobject.embedSWF("pixeleditor06.swf", "flashcontent", "720", "550", "10.1.53", "/swfobject/expressInstall.swf", flashvars, params);
...
<?php include('../content/headernavigation.php'); ?>
		...
		<?php include('../content/subnav.php'); ?>
			...
			<div id="content"><h3>Free Graphics Editor, Make Pixel Art for Games</h3>
<div id="creatorcontainer" style="height: 550px;">
	<div id="flashcontent">
		...
		<p>Learn how to design and draw your own graphics with this <strong>free graphics editor</strong>. With this, you can build your own animated game sprites, game tiles and textures (like <a href="https://www.gimp.org">gimp</a> or other programs) for use in the game maker.</p>
		<p>The graphics editor requires the Adobe Flash plugin. <br /><br /><br /><div align="center" style="margin: auto;"><a href="https://get.adobe.com/flashplayer"><img border="0" alt="Enable Flash" src="enable_flash.gif"/></a></div></p>
		</div>
	</div>
</div>
