...
swfobject.embedSWF("creator5_b22.swf", "flashcontent", "860", "600", "10.2", "/swfobject/expressInstall.swf", flashvars, params);
...
<body id="creator" class="physics" >
	...
	<div id="main">
		<div id="header">
			<div id="title"><h1><a href="/" title="Sploder Make Your Own Games"><span class="hide">Physics Puzzle Game Maker</span></a></h1></div>
			<div id="tools"><ul>
...
(adsbygoogle = window.adsbygoogle || []).push({});
		...
		<div id="page">
			...
			<div id="content"><h3>Physics Puzzle Game Maker</h3>
<div id="creatorcontainer" style="height: 600px; width: 860px">
	<div id="flashcontent">
		...
		<p>Make your own physics puzzle game with this game maker.  Build machines, robots, Rube Goldberg devices, and unique games with this game maker.</p>
		<p>The Flash Physics Puzzle Game Maker requires the Adobe Flash plugin.<br /><br /><br /><div align="center" style="margin: auto;"><a href="https://get.adobe.com/flashplayer"><img border="0" alt="Enable Flash" src="enable_flash.gif"/></a></div></p>
		</div>
	</div>
</div>
