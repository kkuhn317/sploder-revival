...
<?php include('../content/headernavigation.php'); ?>
		<div id="page">
			...
			<div id="content"><h3></h3><div class="mprof">
	<div class="mprofgroup mprofvcard">
		<a href="/members/index.php?u=<?php echo $username ?>"><img class="mprofavatar96" src="../php/avatarproxy.php?u=<?php echo $username ?>" width="96" height="96" alt="mat7772" /></a>
	...
	$f = '20';
									...
									for ($i = 0; $i < count($result); $i++) {
										...
										echo '<div class="game">';
													...
													echo '</div>';
													?>
													<p class="gamedate"><?= date('m&\m\i\d\d\o\t;d&\m\i\d\d\o\t;y', strtotime($result[$i]['date'])) ?></p>
													<?php
			...
			<div class="spacer">&nbsp;</div>
				...
				<?php if(isset($total)){include ('../content/pages.php');} ?>
...
<div class="spacer">&nbsp;</div></div><div class="spacer friends_spacer">&nbsp;</div><div class="spacer">&nbsp;</div></div>
			<div id="sidebar">
					    


    
				<div class="motd_widget motd_winner"><p>Member of the Day: Coming soon!</p><div class="spacer">&nbsp;</div></div>
