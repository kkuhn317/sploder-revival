...
<?php include('../content/headernavigation.php'); ?>
        ...
        <?php include('../content/subnav.php'); ?>
			...
			<div id="content"><h3>Terms of Service</h3><p>Yes, every respectable place has rules you have to follow. By becoming a Sploder Revival&trade; member you agree first and foremost to have <strong>fun</strong>! 
...
<p class="note">Sploder Revival&trade; is a service that allows you to publish customized content to the general public. 
...
<p class="note">Sploder Revival&trade; is meant for a general audience.  Do not use any profane language or post any suggestive or inappropriate material to the public.  We are not responsible for the views expressed in your games.</p>

<p class="alert">SUBMITTING CONTENT THAT IS PORNOGRAPHIC, LIBELOUS, SLANDEROUS, HATEFUL, PROFANE, THREATENING, OR VULGAR MATERIAL TO
...
<p class="note">Sploder.com retains ownership of the game engine and all source code, SWF bytecode, graphics, artwork, ideas and concepts presented on and in conjunction with the site.  Levels created by users remain the property of the user. By creating or submitting User Content you are granting Sploder.xyz unlimited license to host, cache, store, maintain, use, reproduce, publish, distribute, display, exhibit, broadcast, transmit, modify, create derivative works of, adapt, reformat, translate, and otherwise exploit your Submitted User Content in part or in total throughout the universe through any medium.</p>



<h5>Limitation of Liability</h5>

<p class="note">Sploder Revival&trade; will do everything it can to make the use of this system a pleasant one.  However, it must always 

remain true that you expressly understand and agree that under no circumstances shall Sploder Revival&trade; be liable to any 
...
<p class="note">Sploder Revival&trade; will do everything it can to make sure that the integrity of your data on Sploder Revival&trade; remains intact. 
...
<p class="note">Sploder Revival's servers do not have unlimited bandwidth.  Bandwidth limitations apply for all users. Users may not post games hosted on Sploder Revival's servers in such a fashion that the same game is repeated multiple times on the same 
...
repeated, redundant, and sometimes concurrent downloads from Sploder Revival's servers, and quickly uses up bandwidth.</p>
...
<p class="note">If a user uses the system in such a way to adversely effect the performance or efficient operation of the site,
 ...
 Sploder Revival&trade; reserves the right to terminate the user's account. Users must not attempt to circumvent the security and 

 privacy systems in place, or attempt to hack the system.</p>



<p class="note">Sploder Revival&trade; reserves the right to terminate service to you if you do not meet these terms. Sploder Revival&trade; will also cooperate with authorities through its respective service providers.</p>



<p class="note">Sploder Revival&trade; cannot be held responsible for limitations placed on the system by its service providers at the <a href="../credits.php">credits</a> list. This website runs <em>purely</em> on donations and runs <em>no advertisements</em> in any fasion. All donations are used to improve the quality of our service.</p><div class="spacer">&nbsp;</div></div>
			<div id="sidebar">
