...
<?php include('../../content/headernavigation.php'); ?>
        ...
        <input style="width: 150px;" type="number" min="0" name="time" id="username" placeholder="Time (in days)" required/>
...
<br><br>
        ...
        <input type="text" name="username" id="username" placeholder="Username" required/> <input type="submit" value="Unban" />
        <br><br>
        ...
        <input style="width: 350px;" type="text" name="url" id="username" placeholder="Enter game URL" required/> <input type="submit" value="Delete" />
        <div class="spacer">&nbsp;</div><br>
...
<div class="spacer">&nbsp;</div></div>
        ...
        <input type="text" name="username" id="username" placeholder="Username" required/> 
        <div class="spacer">&nbsp;</div><br>
        <input style="width: 100px;" type="number" min="0" name="bp" id="username" placeholder="Boost points" required/> <input type="submit" value="Set" />
        </form>
       <br><br> 
