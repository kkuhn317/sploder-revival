...
<head>
    ...
    swfobject.embedSWF("creator1_b01.swf", "flashcontent", "860", "540", "8", "/swfobject/expressInstall.swf",
        flashvars, params);
    -->
    </script>
...
<body id="creator" class="shooter">
    ...
    <div id="main">
        <div id="header">
            <div id="title">
                <h1><a href="/" title="Sploder Make Your Own Games"><span class="hide">Make My Own Shooter
                            Game</span></a></h1>
            </div>
            <div id="tools">
                <ul>
