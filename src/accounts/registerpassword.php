...
<div id="main">
    <div id="header">
      <a>
      <div id="title"><h1><a title="Sploder"><img style="margin-top:-20px; height: 130px" src="/chrome/logo.png"><span class="hide">Games at Sploder</span></a></h1></div>
        <div id="tools"></div>
      </a>
    </div>   
	<div id="page">
      <div id="content"><h3>Almost there!</h3><p style="font-size: 120%; line-height: 160%;">
</p>
